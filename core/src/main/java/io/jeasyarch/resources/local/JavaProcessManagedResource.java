package io.jeasyarch.resources.local;
...
import io.jeasyarch.utils.ProcessBuilderProvider;
import io.jeasyarch.utils.ProcessUtils;
...
public abstract class JavaProcessManagedResource extends ManagedResource {
    ...
    protected boolean enableProfiling() {
        return context.getJEasyArchContext().getConfiguration().isProfilingEnabled();
    }
