...
import io.jeasyarch.utils.DurationUtils;
...
public abstract class BaseConfigurationBuilder<T extends Annotation, C> {
    ...
    public BaseConfigurationBuilder<T, C> with(String serviceName, JEasyArchContext context) {
    ...
    protected abstract Optional<T> getAnnotationConfig(String serviceName, JEasyArchContext context);
