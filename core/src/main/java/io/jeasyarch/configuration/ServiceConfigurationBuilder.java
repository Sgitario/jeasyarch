...
import io.jeasyarch.api.PortResolutionStrategy;
import io.jeasyarch.core.JEasyArchContext;

public class ServiceConfigurationBuilder
        extends BaseConfigurationBuilder<io.jeasyarch.api.ServiceConfiguration, ServiceConfiguration> {
    ...
    @Override
    protected Optional<io.jeasyarch.api.ServiceConfiguration> getAnnotationConfig(String serviceName,
            JEasyArchContext context) {
        return context.getAnnotatedConfiguration(io.jeasyarch.api.ServiceConfiguration.class,
